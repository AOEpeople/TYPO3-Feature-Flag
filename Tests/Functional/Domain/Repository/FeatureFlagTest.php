 ...
 */
class Tx_FeatureFlag_Tests_Unit_Domain_Repository_FeatureFlagTest extends \TYPO3\CMS\Core\Tests\FunctionalTestCase
{
    /**
     * @var array
     */
    ...
    public function shouldHideElementForBehaviorHideAndEnabledFeatureFlag()
    {
        ...
        $this->assertEquals('1', $contentElement[0]['hidden']);
    }
