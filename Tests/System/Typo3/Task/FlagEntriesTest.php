...
class Tx_FeatureFlag_System_Typo3_Task_FlagEntriesTest extends Tx_Phpunit_TestCase
{
    ...
    {
        $mockRepository = $this->getMock('Tx_FeatureFlag_Domain_Repository_FeatureFlag',
        ...
        $mockConfiguration->expects($this->once())->method('getTables')->will($this->returnValue(array(
                    'table_one',
                    'table_two'
                )));
        $this->flagEntries = $this->getMock('Tx_FeatureFlag_System_Typo3_Task_FlagEntries',
